...
//   dogsJuliaCorrected.splice(0, 1); //start at index 0, remove 1
...
//   const averageYear =
//     humanDogs.reduce((acc, dog) => acc + dog, 0) / humanDogs.length;
//   console.log(averageYear);

//   // const averageYear = humanDogs.reduce((acc, dog, i, arr) => acc + dog / arr.length, 0)
// };
...
// // 6
// const averageWeight = breeds.every(br => br.averageWeight >= '10');
// console.log(averageWeight);

// // 7
// const activeBreeds = breeds.some(br => br.activities.length >= 3);
// console.log(activeBreeds);

// const heaviestFetchBreed = breeds
//   .filter(br => br.activities.includes('fetch'))
//   .map(br => br.averageWeight)
//   .reduce((acc, br) => (acc < br ? br : acc), 0);
...
console.log(
  `Sarah's dog eats ${
    sarahsDog.curFood > sarahsDog.recFood ? 'too much' : 'to little'
  }`
);
...
// 4
console.log(`${ownersTooLittle.join(' and ')} eat too litle.`);
